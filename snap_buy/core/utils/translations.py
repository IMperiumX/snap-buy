...
class TranslationWrapper:
    def __init__(self, instance, locale):
        ...
        self.translation = next(
            (t for t in instance.translations.all() if t.language_code == locale),
            None,
        )
...
class Translation(models.Model):
    ...
    def get_translated_object_id(self) -> tuple[str, int | str]:
        msg = "Models extending Translation should implement get_translated_object_id"
        raise NotImplementedError(msg)

    def get_translated_keys(self) -> dict[str, Any]:
        msg = "Models extending Translation should implement get_translated_keys"
        raise NotImplementedError(msg)
