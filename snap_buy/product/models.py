...
from snap_buy.core.models import PublishableModel
from snap_buy.core.models import SortableModel
from snap_buy.core.units import WeightUnits
from snap_buy.core.utils import build_absolute_uri
from snap_buy.core.utils.editorjs import clean_editor_js
from snap_buy.core.utils.translations import Translation
from snap_buy.core.utils.translations import get_translation
...
from snap_buy.permission.enums import ProductPermissions
from snap_buy.permission.enums import ProductTypePermissions
from snap_buy.seo.models import SeoModel
from snap_buy.seo.models import SeoModelTranslation
...
class ProductChannelListing(PublishableModel):
    ...
    discounted_price = MoneyField(
        amount_field="discounted_price_amount",
...
class ProductVariant(SortableModel, ModelWithMetadata, ModelWithExternalReference):
    ...
    def get_price(
        ...
        """
        from snap_buy.discount.utils.promotion import (
